...
public class CategoryController {
	...
	public ResponseEntity<List<ApiCategory>> findAllCategories() {
		return ResponseEntity.ok(categoryService.findAll());
	}
	
	@GetMapping(CATEGORY_ID)
	@Operation(summary = "Find a category", description = "Find a category by his ID")
	public ResponseEntity<ApiCategory> findCategoryById(@PathVariable Long categoryId) {
	...
	public ResponseEntity<ApiCategory> saveCategory(@Valid @RequestBody ApiCategory apiBrand) {
	...
	public ResponseEntity<ApiCategory> updateCategory(@PathVariable Long categoryId, @Valid @RequestBody ApiCategory apiBrand) {
	...
	public ResponseEntity<ApiProduct> deleteCategory(@PathVariable Long categoryId) {
