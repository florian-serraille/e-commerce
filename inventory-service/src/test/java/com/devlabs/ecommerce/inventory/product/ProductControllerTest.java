...
class ProductControllerTest {
	...
	void findAllProducts() throws Exception {
		...
		// Given
		List<ApiProduct> expectedProducts = ApiProductCatalog.getProductList();
	...
	void findProductById_ThenSuccess() throws Exception {
		...
		// Given
		ApiProduct expectedProduct = ApiProductCatalog.getProductWithId();
	...
	void saveProduct() throws Exception {
		...
		final ApiProduct expectedProduct = ApiProductCatalog.getProductWithoutId();
		Mockito.when(productService.save(expectedProduct))
		       .thenReturn(ApiProductCatalog.getProductWithId());
	...
	void saveProductWithConstraintsViolation() throws Exception {
		...
		// Given
		final ObjectMapper mapper = new ObjectMapper();
		final ApiProduct expectedProduct = ApiProductCatalog.getProductWithConstraintViolation();
